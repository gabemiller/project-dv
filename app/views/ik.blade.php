...
<p>Számrendszerek gyakorló {{HTML::link('ik/szamrendszerek','feladatsor',array())}} megoldással.</p>
<p>Számábrázolás gyakorló {{HTML::link('ik/szamabrazolas','feladatsor',array())}} megoldással + segédanyag.</p>
<p>Aritmetikai feladatok gyakorló {{HTML::link('ik/aritmetika','feladatsor',array())}} megoldással.</p>
